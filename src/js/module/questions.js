export const questions = [
  ...
  {
    text: "Вы записались в поликлинику на прививку, но в день X перепутали время. На вас ворчит женщина из регистратуры и осуждающе смотрит вся очередь. Что почувствуете?",
    answers: [
      {
        text: "Ну, бывает. Спокойно посижу в очереди, может, ещё получится договориться с доктором",
        points: 3
      },
      {
